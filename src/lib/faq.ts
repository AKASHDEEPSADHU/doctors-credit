export const FAQS: [string, string][] = [
  ...
  [
    ...
    "Only when a qualified clinician clears you to fly. Flying too soon after some operations raises clot and complication risk. DCredit will not treat a cheap ticket as a clinical plan, and the $5 Initial Assessment is not medical clearance.",
  ],
  [
    "Who chooses the doctor?",
    "You do. DCredit does not independently diagnose and does not require you to use a particular surgeon. Individual clinician profiles are being developed and will be published only when facts can be checked against reliable sources.",
  ],
  [
  ...
  [
    "What is NABH?",
    "NABH accreditation is an independent Indian accreditation framework focused on healthcare quality and patient safety. Standards cover areas including patient rights, infection control, medication management, patient safety and quality improvement. Source: National Accreditation Board for Hospitals & Healthcare Providers (nabh.co). Accreditation is not a guarantee of outcome.",
  ],
  [
    "What is JCI?",
  ...
  [
    ...
    "Not yet. The current DCredit application does not provide a medical-record vault or secure document-upload service. Please do not send MRI scans, prescriptions, diagnoses or other sensitive medical records through the contact form or ordinary WhatsApp. If you proceed to a future care-evaluation stage, we will provide the appropriate secure process when available.",
  ],
  [
    "Will DCredit review my medical records?",
  ...
  [
    "How do I know DCredit is legitimate?",
  ...
  [
    ...
    "The $5 Initial Assessment pays for a coordinator conversation and case-opening. If we tell you India is not appropriate to explore, the five dollars still stand as payment for that work. See the refund policy.",
  ],
  [
    "Do I have to travel if I start an assessment?",
  ...
  [
    ...
    "No. No medical outcome or savings figure is guaranteed.",
  ],
  [
  ...
  [
    ...
    "Some healthcare providers may later compensate DCredit for coordination or referral services. Where applicable, that relationship will be disclosed. We do not claim to be “completely independent” if such compensation exists on a given case.",
  ],
  [
  ...
  [
    ...
    "Hospital and travel cancellations follow the provider’s and airline’s rules. You are not obliged to travel because you paid for a $5 Initial Assessment. Any future DCredit services will follow the refund policy.",
  ],
  [
